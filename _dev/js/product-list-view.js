    ...
    window.CDT = jQuery.extend(window.CDT || {}, {
        list_participants: {
            setupQuantity: function(product) {
                var capture_area = product.find(".details ul li.capture-details.price");

                capture_area.prepend('Number of Participants<input type="text" class="productTextInput quantity-field number-of-participants" value="1" />Participant Names');
                capture_area.after('<li class="price"><a class="pointer validate-participants">Book Now ></a></li>');
            },
            ...
            validateFields: function() {
                var capture_area = jQuery(".details ul li.capture-details.price"),
                    valid = true;
            ...
            concatenateFields: function() {
                var capture_details = jQuery(".details ul li.capture-details.price"),
                    concatString = "";
                ...
                jQuery("[data-applyMultipleParticipants]").each(function() {
                    ...
                    product.find(".validate-participants").on("click", function(e) {
                        ...
                        if (numParticipants > 0) {
                            ...
                            if (valid) {
                                product.find(".details ul li.capture-details.price-input").val(CDT.list_participants.concatenateFields(product));
